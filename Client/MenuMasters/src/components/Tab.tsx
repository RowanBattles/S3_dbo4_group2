const Tab = () => {
    return (
        <div className=" p-5">
          <div className="">
            <div className="green rounded-t-3xl p-4 border-x border-t border-slate-300">
            ...
            <div className="white rounded-b-3xl p-5 flex justify-end text-white gap-4 border-x border-b border-slate-300">
              <button className="green px-5 py-1 rounded-full">Edit</button>
              <button className="green px-5 py-1 rounded-full">Pay</button>
            </div>
          </div>
        </div>
    );
